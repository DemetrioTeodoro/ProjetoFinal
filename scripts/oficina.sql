...
CREATE TABLE IF NOT EXISTS `oficina`.`peca` (
  ...
  `CODIGO` VARCHAR(13) NULL DEFAULT NULL,
  PRIMARY KEY (`IDPECA`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `oficina`.`orcamento` (
  ...
  `NUORCAMENTO` VARCHAR(45) NULL DEFAULT NULL,
...
INSERT INTO LOGIN (IDUSUARIO,LOGIN,SENHA,TIPO) VALUES (1, 'GODOFREDO',123,'M');
INSERT INTO LOGIN (IDUSUARIO,LOGIN,SENHA,TIPO) VALUES (2, 'JEORGE',123,'M');
INSERT INTO LOGIN (IDUSUARIO,LOGIN,SENHA,TIPO) VALUES (3, 'LUCAS',123,'M');
